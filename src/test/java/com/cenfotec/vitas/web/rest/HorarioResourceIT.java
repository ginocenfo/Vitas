...
import com.cenfotec.vitas.domain.Horario;
import com.cenfotec.vitas.repository.HorarioRepository;
import com.cenfotec.vitas.service.dto.HorarioDTO;
import com.cenfotec.vitas.service.mapper.HorarioMapper;
...
class HorarioResourceIT {
    ...
    public static Horario createEntity(EntityManager em) {
        Horario horario = new Horario().horaEntrada(DEFAULT_HORA_ENTRADA).horaSalida(DEFAULT_HORA_SALIDA);
        return horario;
    }
    ...
    public static Horario createUpdatedEntity(EntityManager em) {
        Horario horario = new Horario().horaEntrada(UPDATED_HORA_ENTRADA).horaSalida(UPDATED_HORA_SALIDA);
        return horario;
    }
    ...
    void createHorario() throws Exception {
        ...
        assertThat(testHorario.getHoraEntrada()).isEqualTo(DEFAULT_HORA_ENTRADA);
        assertThat(testHorario.getHoraSalida()).isEqualTo(DEFAULT_HORA_SALIDA);
    }
    ...
    void putNewHorario() throws Exception {
        ...
        updatedHorario.horaEntrada(UPDATED_HORA_ENTRADA).horaSalida(UPDATED_HORA_SALIDA);
        ...
        Horario testHorario = horarioList.get(horarioList.size() - 1);
        assertThat(testHorario.getHoraEntrada()).isEqualTo(UPDATED_HORA_ENTRADA);
        assertThat(testHorario.getHoraSalida()).isEqualTo(UPDATED_HORA_SALIDA);
    }
    ...
    void partialUpdateHorarioWithPatch() throws Exception {
        ...
        partialUpdatedHorario.horaEntrada(UPDATED_HORA_ENTRADA);
    ...
    void fullUpdateHorarioWithPatch() throws Exception {
        ...
        partialUpdatedHorario.horaEntrada(UPDATED_HORA_ENTRADA).horaSalida(UPDATED_HORA_SALIDA);

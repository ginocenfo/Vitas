...
import com.cenfotec.vitas.service.HorarioService;
...
/**
 * REST controller for managing {@link com.cenfotec.vitas.domain.Horario}.
 */
@RestController
@RequestMapping("/api")
public class HorarioResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/horarios/{id}", consumes = "application/merge-patch+json")
